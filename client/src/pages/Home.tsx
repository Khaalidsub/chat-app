    ...
    return (
        <React.Fragment>
            <div className="flex justify-center">
                ...
                <div className="md:h-2/3 md:w-2/3 h-4/5 m-6  mx-auto my-auto flex flex-row py-px border border-gray-50 bg-gray-50 rounded-3xl shadow-lg">
                    <div className="md:w-2/5 md:flex hidden">
                        <Chats chats={data ? data.chats : []} onClick={setCurrentChat} currentUser={props.currentUser.id} />
                    </div>

                    <div className="w-full md:w-3/5 pt-3 rounded-3xl">
